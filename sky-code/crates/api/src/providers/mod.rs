...
const MODEL_REGISTRY: &[(&str, ProviderMetadata)] = &[
    (
        ...
        ProviderMetadata {
            ...
            auth_env: "FILANTHROPIC_API_KEY",
            base_url_env: "FILANTHROPIC_BASE_URL",
...
mod tests {
    ...
    fn detects_provider_from_model_name_first() {
        ...
        assert_eq!(
            detect_provider_kind("cloud-sannet-4-6"),
            ProviderKind::ClawApi
        );
    }
    ...
    fn keeps_existing_max_token_heuristic() {
        assert_eq!(max_tokens_for_model("apus"), 32_000);
